export const theme = {
  "neutral": { "chroma": 0.000, "hue": 180.000 },
  "primary": { "chroma": 0.125, "hue": 225.000 },
  "ok":      { "chroma": 0.125, "hue": 148.000 },
  "warn":    { "chroma": 0.125, "hue":  73.000 },
  "error":   { "chroma": 0.125, "hue":  18.000 },
};
...
--color-neutral-50: #000;
--color-neutral-100: #030303;
--color-neutral-200: #161616;
...
--color-neutral-950: #eee;


// Dark
--color-neutral-50: oklch(.985 .001 106.423);
--color-neutral-100: oklch(.97 .001 106.424);
--color-neutral-200: oklch(.923 .003 48.717);
--color-neutral-300: oklch(.869 .005 56.366);
--color-neutral-400: oklch(.709 .01 56.259);
--color-neutral-500: oklch(.553 .013 58.071);
--color-neutral-600: oklch(.444 .011 73.639);
--color-neutral-700: oklch(.374 .01 67.558);
--color-neutral-800: oklch(.268 .007 34.298);
--color-neutral-900: oklch(.216 .006 56.043);
--color-neutral-950: oklch(.147 .004 49.25);
--color-primary-50: oklch(.977 .013 236.62);
--color-primary-100: oklch(.951 .026 236.824);
--color-primary-200: oklch(.901 .058 230.902);
--color-primary-300: oklch(.828 .111 230.318);
...
--color-primary-800: oklch(.443 .11 240.79);
--color-primary-900: oklch(.391 .09 240.876);
--color-primary-950: oklch(.293 .066 243.157);
--color-ok-50: oklch(.982 .018 155.826);
--color-ok-100: oklch(.962 .044 156.743);
--color-ok-200: oklch(.925 .084 155.995);
--color-ok-300: oklch(.871 .15 154.449);
--color-ok-400: oklch(.792 .209 151.711);
--color-ok-500: oklch(.723 .219 149.579);
--color-ok-600: oklch(.627 .194 149.214);
--color-ok-700: oklch(.527 .154 150.069);
--color-ok-800: oklch(.448 .119 151.328);
--color-ok-900: oklch(.393 .095 152.535);
--color-ok-950: oklch(.266 .065 152.934);
--color-warn-50: oklch(.987 .026 102.212);
--color-warn-100: oklch(.973 .071 103.193);
--color-warn-200: oklch(.945 .129 101.54);
--color-warn-300: oklch(.905 .182 98.111);
--color-warn-400: oklch(.852 .199 91.936);
--color-warn-500: oklch(.795 .184 86.047);
--color-warn-600: oklch(.681 .162 75.834);
--color-warn-700: oklch(.554 .135 66.442);
--color-warn-800: oklch(.476 .114 61.907);
--color-warn-900: oklch(.421 .095 57.708);
--color-warn-950: oklch(.286 .066 53.813);
--color-error-50: oklch(.971 .013 17.38);
--color-error-100: oklch(.936 .032 17.717);
--color-error-200: oklch(.885 .062 18.334);
--color-error-300: oklch(.808 .114 19.571);
--color-error-400: oklch(.704 .191 22.216);
--color-error-500: oklch(.637 .237 25.331);
--color-error-600: oklch(.577 .245 27.325);
--color-error-700: oklch(.505 .213 27.518);
--color-error-800: oklch(.444 .177 26.899);
--color-error-900: oklch(.396 .141 25.723);
--color-error-950: oklch(.258 .092 26.042);

// Light
--color-neutral-50: oklch(.147 .004 49.25);
--color-neutral-100: oklch(.216 .006 56.043);
--color-neutral-200: oklch(.268 .007 34.298);
--color-neutral-300: oklch(.374 .01 67.558);
--color-neutral-400: oklch(.444 .011 73.639);
--color-neutral-500: oklch(.553 .013 58.071);
--color-neutral-600: oklch(.709 .01 56.259);
--color-neutral-700: oklch(.869 .005 56.366);
--color-neutral-800: oklch(.923 .003 48.717);
--color-neutral-900: oklch(.97 .001 106.424);
--color-neutral-950: oklch(.985 .001 106.423);
--color-primary-50: oklch(.293 .066 243.157);
--color-primary-100: oklch(.391 .09 240.876);
--color-primary-200: oklch(.443 .11 240.79);
--color-primary-300: oklch(.5 .134 242.749);
--color-primary-400: oklch(.588 .158 241.966);
--color-primary-500: oklch(.685 .169 237.323);
--color-primary-600: oklch(.746 .16 232.661);
--color-primary-700: oklch(.828 .111 230.318);
--color-primary-800: oklch(.901 .058 230.902);
--color-primary-900: oklch(.951 .026 236.824);
--color-primary-950: oklch(.977 .013 236.62);
--color-ok-50: oklch(.266 .065 152.934);
--color-ok-100: oklch(.393 .095 152.535);
--color-ok-200: oklch(.448 .119 151.328);
--color-ok-300: oklch(.527 .154 150.069);
--color-ok-400: oklch(.627 .194 149.214);
--color-ok-500: oklch(.723 .219 149.579);
--color-ok-600: oklch(.792 .209 151.711);
--color-ok-700: oklch(.871 .15 154.449);
--color-ok-800: oklch(.925 .084 155.995);
--color-ok-900: oklch(.962 .044 156.743);
--color-ok-950: oklch(.982 .018 155.826);
--color-warn-50: oklch(.286 .066 53.813);
--color-warn-100: oklch(.421 .095 57.708);
--color-warn-200: oklch(.476 .114 61.907);
--color-warn-300: oklch(.554 .135 66.442);
--color-warn-400: oklch(.681 .162 75.834);
--color-warn-500: oklch(.795 .184 86.047);
--color-warn-600: oklch(.852 .199 91.936);
--color-warn-700: oklch(.905 .182 98.111);
--color-warn-800: oklch(.945 .129 101.54);
--color-warn-900: oklch(.973 .071 103.193);
--color-warn-950: oklch(.987 .026 102.212);
--color-error-50: oklch(.258 .092 26.042);
--color-error-100: oklch(.396 .141 25.723);
--color-error-200: oklch(.444 .177 26.899);
--color-error-300: oklch(.505 .213 27.518);
--color-error-400: oklch(.577 .245 27.325);
--color-error-500: oklch(.637 .237 25.331);
--color-error-600: oklch(.704 .191 22.216);
--color-error-700: oklch(.808 .114 19.571);
--color-error-800: oklch(.885 .062 18.334);
--color-error-900: oklch(.936 .032 17.717);
--color-error-950: oklch(.971 .013 17.38);
